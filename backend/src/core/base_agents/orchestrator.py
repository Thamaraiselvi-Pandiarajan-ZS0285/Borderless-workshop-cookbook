...
from backend.src.prompts.orchestration_prompt import *
...
from backend.src.prompts.retrieval_prompt import RETRIEVAL_PROMPT
from backend.src.core.base_agents.session_memory_manager import SharedMemoryManager, DatabaseMemory
            ...
            try:
                ...
                if self.memory_manager:
                    await self.memory_manager.add_message_to_shared_memory(
                        ...
                        sender=EMAIL_CLASSIFIER_AGENT_NAME,
                        role="assistant",
                        metadata={"delegation": "classification_planner", "stage": "classification", "error": True,
                                  "content": str(e)}
                    )
            ...
            try:
                ...
                if self.memory_manager:
                    await self.memory_manager.add_message_to_shared_memory(
                        ...
                        sender=RETRIEVAL_AGENT_NAME,
                        role="assistant",
                        metadata={"delegation": "retrieval_planner", "stage": "retrieval", "error": True,
                                  "content": str(e)}
                    )
